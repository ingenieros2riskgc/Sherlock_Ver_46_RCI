<%@ Page Title="Sherlock" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MastersPages/Admin.Master" AutoEventWireup="true"
    CodeBehind="ConsultarFormClienteFCC.aspx.cs" Inherits="ListasSarlaft.Formularios.Admin.ConsultarFormClienteFCC" %>

<%@ OutputCache Location="None" %>

<%@ Register TagPrefix="CCCFC" TagName="ConsultarFormCliente1" Src="~/UserControls/Sarlaft/ConsultarFormClienteFCC.ascx" %>
