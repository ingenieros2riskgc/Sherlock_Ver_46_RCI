<%@ Page Title="Sherlock" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MastersPages/Admin.Master" AutoEventWireup="true"
    CodeBehind="AdminFormClienteZurich.aspx.cs" Inherits="ListasSarlaft.Formularios.Admin.AdminFormClienteZurich" %>

<%@ OutputCache Location="None" %>

<%@ Register TagPrefix="CCFC" TagName="FormCliente1" Src="~/UserControls/Sarlaft/FormClienteZurich.ascx" %>
