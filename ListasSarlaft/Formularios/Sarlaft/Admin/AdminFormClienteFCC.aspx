<%@ Page Title="Sherlock" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MastersPages/Admin.Master" AutoEventWireup="true"
    CodeBehind="AdminFormClienteFCC.aspx.cs" Inherits="ListasSarlaft.Formularios.Admin.AdminFormClienteFCC" %>

<%@ OutputCache Location="None" %>

<%@ Register TagPrefix="CCFC" TagName="FormCliente1" Src="~/UserControls/Sarlaft/FormClienteFCC.ascx" %>
