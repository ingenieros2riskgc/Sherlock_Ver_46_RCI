<%@ Page Title="Sherlock" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MastersPages/Admin.Master" AutoEventWireup="true"
    CodeBehind="AdminFormClienteCopidrogas.aspx.cs" Inherits="ListasSarlaft.Formularios.Admin.AdminFormClienteCopidrogas" %>

<%@ OutputCache Location="None" %>

<%@ Register TagPrefix="CCFC" TagName="FormCliente1" Src="~/UserControls/Sarlaft/FormClienteCopidrogas.ascx" %>
