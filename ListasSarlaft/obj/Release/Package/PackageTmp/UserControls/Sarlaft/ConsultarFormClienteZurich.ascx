<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConsultarFormClienteZurich.ascx.cs"
    Inherits="ListasSarlaft.UserControls.ConsultarFormClienteZurich" %>
                            ...
                            <td>
                                <h1 style="font-size: 13px;">
                                    <table border="1px" style="width: 1015px">
                                        ...
                                        <tr id="infoNota1" visible="false" runat="server">
                                            <td>
                                                <table width="100%">
                                                    <tr valign="middle">
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Label7" runat="server" Text="SEGUNDO NOMBRE"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="100%">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label13" runat="server" Text="DIRECCIÓN RESIDENCIA"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="TextBox25" runat="server" Width="500px" MaxLength="100"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="Label25" runat="server" Text="CIUDAD RESIDENCIA"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label26" runat="server" Text="TELÉFONO"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label29" runat="server" Text="ACTIVIDAD ECONÓMICA PRINCIPAL"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Label30" runat="server" Text="SI ES INDEPENDIENTE, ESPECIFIQUE:"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="100%">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label31" runat="server" Text="NOMBRE DE LA EMPRESA DONDE TRABAJA"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:TextBox ID="TextBox18" runat="server" Width="300px" MaxLength="80"></asp:TextBox>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="Label32" runat="server" Text="CARGO"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="100%">
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label33" runat="server" Text="CIUDAD"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Label36" runat="server" Text="FAX"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label37" runat="server" Text="ES USTED SUJETO DE OBLIGACIONES TRIBUTARIAS EN OTRO PAÍS O GRUPO DE PAISES?"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Label38" runat="server" Text="ESPECIFIQUE EL PAÍS:"></asp:Label>
                                                                    </td>
                                                                    <td>
                                        ...
                                        <tr id="infoTituloPJ" visible="false" runat="server">
                                            <td>
                                                <table width="100%">
                                                    <tr align="center">
                                                        <td style="background-color: #C0C0C0">
                                                            <asp:Label ID="Label49" runat="server" Text="1. INFORMACIÓN BÁSICA"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                        ...
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Label40" runat="server" Text="SEGUNDO NOMBRE"></asp:Label>
                                                                    </td>
                                                                    <td>
                                        ...
                                        <tr id="infoPF1" visible="false" runat="server">
                                            <td>
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label41" runat="server" Text="TIENE PRODUCTOS FINACIEROS EN EL EXTERIOR?"></asp:Label>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="Label42" runat="server" Text="TIPO DE PRODUCTO"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label76" runat="server" Text="IDENTIFICACION O NÚMERO DEL PRODUCTO"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label77" runat="server" Text="ENTIDAD"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label78" runat="server" Text="MONTO"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label79" runat="server" Text="CIUDAD"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label80" runat="server" Text="PAIS"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:Label ID="Label81" runat="server" Text="MONEDA"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                        ...
                                        <tr id="infoTituloDocRequeridos" visible="false" runat="server">
                                            <td>
                                                <table width="100%">
                                                    <tr align="center" style="background-color: #C0C0C0">
                                                        <td>
                                        ...
                                        <tr id="infoDocRequeridos" valign="top" visible="false" runat="server">
                                            <td>
                                                <table width="100%">
                                                    <tr>
                                                        <td>
                                        ...
                                        <tr id="infoNota3" visible="false" runat="server">
                                            <td>
                                                <table width="100%">
                                                    <tr valign="middle">
                                                        <td style="background-color: #DDDDDD;">
                                                                            ...
                                                                            <tr>
                                                                                <td style="height: 43px">
                                                                                    <table>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:Label ID="Label152" runat="server" Text="LUGAR DE LA ENTREVISTA" Width="136px"></asp:Label>
                                                                                            </td>
                                                                                            <td>
                                                                                                <asp:TextBox ID="TextBox94" runat="server" MaxLength="20" Width="136px"></asp:TextBox>
                                                                                            </td>
                                                                                            <td>
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                <asp:CalendarExtender ID="CalendarExtender6" runat="server" Format="dd-MMM-yyyy" TargetControlID="TextBox95" />
                                                                                            </td>
                                                                                            <td>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <table>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:Label ID="Label156" runat="server" Text="C.C. No. "></asp:Label>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <table>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:Label ID="Label161" runat="server" Text="OBSERVACIONES"></asp:Label>
                                                                                            </td>
                                                                                            <td>
                                                                            ...
                                                                            <tr>
                                                                                <td style="height: 43px">
                                                                                    <table>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:Label ID="Label162" runat="server" Text="NOMBRE FUNCIONARIO QUE VERIFICA CONTENIDO Y SOPORTES DEL FORMULARIO" Width="320px"></asp:Label>
                                                                                            </td>
                                                                                            <td>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <table>
                                                                                        <tr>
                                                                                            <td style="height: 43px">
                                                                                                <asp:Label ID="Label164" runat="server" Text="FIRMA FUNCIONARIO RESPONSABLE DE VERIFICAR CONTENIDO Y SOPORTES"></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td style="height: 90px"></td>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:Label ID="Label216" runat="server" Text="________________________________________________"></asp:Label>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:Label ID="Label217" runat="server" Text="C.C. No. "></asp:Label>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <table>
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:Label ID="Label218" runat="server" Text="OBSERVACIONES"></asp:Label>
                                                                                            </td>
                                                                                            <td>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <table>
                                                                                        ...
                                                                                        <tr align="center">
                                                                                            <td bgcolor="#BBBBBB">
                                                                                                <asp:Label ID="Label1990" runat="server" Text="Adjuntar documento .pdf:" Font-Names="Calibri"
                                                                                                    Font-Size="Small"></asp:Label>
                                                                                            </td>
                                                                                            <td>
