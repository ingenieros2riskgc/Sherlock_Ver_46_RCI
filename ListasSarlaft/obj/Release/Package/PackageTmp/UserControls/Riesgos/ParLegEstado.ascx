<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParLegEstado.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Riesgos.ParLegEstado" %>
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Estado legislación"></asp:Label>
                </td>
            </tr>
            <tr align="center">
                <td>
                        ...
                        <tr align="center">
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="Estado legislación" DataField="NombreEstadoLegislacion" />
            ...
            <tr align="center" id="trCampos" runat="server" visible="false">
                <td>
                    <table>
                        <tr align="center">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Estado legislación" Font-Names="Calibri"
