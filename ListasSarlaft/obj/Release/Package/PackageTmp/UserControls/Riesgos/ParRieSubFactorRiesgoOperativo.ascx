<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParRieSubFactorRiesgoOperativo.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Riesgos.ParRieSubFactorRiesgoOperativo" %>
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Sub factor de riesgo operativo"></asp:Label>
                </td>
            </tr>
            <tr align="center">
                <td>
                        ...
                        <tr align="center">
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="Factor riesgo operativo" DataField="NombreFactorRiesgoOperativo" />
                                        <asp:BoundField HeaderText="Sub factor riesgo operativo" DataField="NombreTipoRiesgoOperativo" />
            ...
            <tr align="center" id="trCampos" runat="server" visible="false">
                <td>
                    <table>
                        <tr align="left">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Factor de riesgo operativo" Font-Names="Calibri"
                        ...
                        <tr align="center">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Sub factor de riesgo operativo" Font-Names="Calibri"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#EEEEEE">
