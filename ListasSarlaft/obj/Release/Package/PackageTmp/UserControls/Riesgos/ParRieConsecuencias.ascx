<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParRieConsecuencias.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Riesgos.ParRieConsecuencias" %>
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Consecuencias"></asp:Label>
                </td>
            </tr>
            <tr align="center">
                <td>
                        ...
                        <tr align="center">
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="Consecuencia" DataField="NombreConsecuencia" />
            ...
            <tr align="center" id="trCampos" runat="server" visible="false">
                <td>
                    <table>
                        <tr align="center">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Consecuencia" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#EEEEEE">
                                <asp:TextBox ID="TextBox1" runat="server" Width="450px" Font-Names="Calibri" Font-Size="Small" MaxLength="200"></asp:TextBox>
                                <asp:AutoCompleteExtender ID="TextBox1_AutoCompleteExtender" runat="server" BehaviorID="TextBox1_AutoCompleteExtender"
                                    DelimiterCharacters="" TargetControlID="TextBox1"
                                    ServicePath="~/Formularios/WebService/AutoCompletar.asmx"
                                    ServiceMethod="GetConsecuencias" FirstRowSelected="false" CompletionInterval="1000"
