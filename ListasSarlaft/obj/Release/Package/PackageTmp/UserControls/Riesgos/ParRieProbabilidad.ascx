<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParRieProbabilidad.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Riesgos.ParRieProbabilidad" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table align="center" bgcolor="#EEEEEE">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Frecuencia"></asp:Label>
                </td>
            </tr>
            <tr align="center">
                <td>
                    <table>
                        <tr align="left">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label7" runat="server" Text="Valor frecuencia" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label8" runat="server" Text="Nombre frecuencia" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                            </td>
                        </tr>
                        <tr align="left">
                            <td bgcolor="#BBBBBB">
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="lblImagenFrecuencia" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Imagen o Gráfica de Frecuencia"></asp:Label>
                </td>
            </tr>
            <tr>
                <td bgcolor="#BBBBBB">
