<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParRieClasificacionParticularRiesgo.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Riesgos.ParRieClasificacionParticularRiesgo" %>
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Clasificación particular"></asp:Label>
                </td>
            </tr>
            <tr align="center">
                <td>
                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Clasificación particular" DataField="NombreClasificacionParticularRiesgo" />
            ...
            <tr align="center" id="trCampos" runat="server" visible="false">
                <td>
                    <table>
                        ...
                        <tr align="center">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Clasificación particular" Font-Names="Calibri"
                                    Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#EEEEEE">
