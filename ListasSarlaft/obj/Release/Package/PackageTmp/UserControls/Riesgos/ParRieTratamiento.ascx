<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParRieTratamiento.ascx.cs" Inherits="ListasSarlaft.UserControls.Riesgos.ParRieTratamiento" %>
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Tratamiento"></asp:Label>
                </td>
            </tr>
            <tr align="center">
                <td>
                        ...
                        <tr align="center">
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="Tratamiento" DataField="NombreTratamiento" />
            ...
            <tr align="center" id="trCampos" runat="server" visible="false">
                <td>
                    <table>
                        <tr align="center">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Tratamiento" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#EEEEEE">
