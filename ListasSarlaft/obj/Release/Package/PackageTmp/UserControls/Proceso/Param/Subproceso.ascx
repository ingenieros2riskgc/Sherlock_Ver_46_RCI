<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Subproceso.ascx.cs" Inherits="ListasSarlaft.UserControls.Proceso.Subproceso" %>
    ...
    <ContentTemplate>
        ...
        <table align="center" width="100%">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Subproceso" Font-Bold="False"
            ...
            <tr align="center" bgcolor="#EEEEEE" id="filaGrid" runat="server" visible="true">
                <td bgcolor="#EEEEEE">
                    ...
                    <table>
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4"
                                    ...
                                    DataKeyNames="intIdProceso,strNombreUsuario,strDescripcion,strObjetivo,intIdMacroProceso,intIdCadenaValor,intIdCargoResponsable,strCargoResponsable" OnPageIndexChanging="GridView1_PageIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="strNombreSubproceso" HeaderText="Subproceso" SortExpression="strNombreSubproceso" HtmlEncodeFormatString="True" HtmlEncode="False">
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="strDescripcion" HeaderText="Descripción" SortExpression="strDescripcion" HtmlEncodeFormatString="True"
                                            Visible="False" HtmlEncode="False" />
                                        <asp:BoundField DataField="strObjetivo" HeaderText="Objetivo" SortExpression="strObjetivo" Visible="False" HtmlEncodeFormatString="True" HtmlEncode="False" />
                                        ...
                                        <asp:BoundField DataField="intIdCargoResponsable" HeaderText="IdResponsable" SortExpression="intIdCargoResponsable" Visible="False" />
                                        <asp:BoundField DataField="strCargoResponsable" HeaderText="Cargo Responsable" SortExpression="strCargoResponsable" Visible="False"></asp:BoundField>
                                        <asp:BoundField DataField="intIdProceso" HeaderText="IdProceso" ReadOnly="True" SortExpression="intIdProceso" InsertVisible="False" Visible="False"></asp:BoundField>
                                        <asp:BoundField DataField="strNombreProceso" HeaderText="Proceso" SortExpression="strNombreProceso" HtmlEncode="False">
                                            <ItemStyle HorizontalAlign="Left" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="intIdMacroProceso" HeaderText="IdMacroproceso" SortExpression="intIdMacroProceso" Visible="False" />
                                        <asp:BoundField DataField="intIdCadenaValor" HeaderText="IdCadenaValor" SortExpression="intIdCadenaValor" Visible="False" />
                                        <asp:BoundField DataField="dtFechaRegistro" HeaderText="FechaRegistro" ReadOnly="True" SortExpression="dtFechaRegistro">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                        ...
                        <tr>
                            <td align="right">
                                <asp:ImageButton ID="imgBtnInsertarNuevo" runat="server" CausesValidation="False" CommandName="Insert"
                                    ImageUrl="~/Imagenes/Icons/Add.png" Text="Insert"
                                    OnClick="imgBtnInsertarNuevo_Click" ToolTip="Insertar" />
                            </td>
                        </tr>
                    </table>
                    <br />
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#EEEEEE">
                    <table class="tabla" width="100%">
                        ...
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                <asp:Label ID="Label19" runat="server" Text="Cadena de Valor:" CssClass="Apariencia"></asp:Label>
                            </td>
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvCadenaValor" runat="server" ControlToValidate="ddlCadenaValor"
                                    ...
                                    ValidationGroup="iSubProceso" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlMacroproceso" runat="server" Width="300px"
                                    CssClass="Apariencia" AutoPostBack="True"
                                    DataTextField="Nombre" DataValueField="IdMacroproceso"
                        ...
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                <asp:Label ID="Label7" runat="server" Text="Proceso:" CssClass="Apariencia"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlProceso" runat="server" Width="300px"
                                    CssClass="Apariencia" AutoPostBack="False" DataTextField="Nombre" DataValueField="IdProceso">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rfvProceso" runat="server" ControlToValidate="ddlProceso"
                                    ErrorMessage="Debe ingresar el proceso." ToolTip="Debe ingresar el proceso."
                                    ValidationGroup="iSubProceso" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ControlToValidate="txtNombre"
                                    ...
                                    ValidationGroup="iSubProceso" ForeColor="Red">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                        ...
                        <tr>
                            ...
                            <td>
                                <table class="tablaSinBordes">
                                    <tr>
                                        <td>
                                            <asp:TextBox ID="txtResponsable" runat="server" Width="212px" CssClass="Apariencia"
                        ...
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                <asp:Label ID="Label12" runat="server" Text="Estado:" CssClass="Apariencia"></asp:Label>
                            </td>
                            <td>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iSubProceso" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ValidationGroup="iSubProceso"
                                                ToolTip="Guardar" />
                                        </td>
                                        <td>
                        ...
                        <tr align="left" id="Cabecera" runat="server">
                            <td bgcolor="#EEEEEE">
                                <table id="Table1" class="tabla" runat="server">
                                    ...
                                    <tr>
                                        <td align="left" bgcolor="#BBBBBB">
                                            <asp:Label ID="Label8" runat="server" Text="Descripción:" CssClass="Apariencia"></asp:Label>
                                        </td>
                                        <td>
