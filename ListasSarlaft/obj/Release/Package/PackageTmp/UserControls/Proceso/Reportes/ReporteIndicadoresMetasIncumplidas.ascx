<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReporteIndicadoresMetasIncumplidas.ascx.cs" Inherits="ListasSarlaft.UserControls.Proceso.Reportes.ReporteIndicadoresMetasIncumplidas" %>
...
<asp:UpdatePanel ID="RIMIbody" runat="server">
    <ContentTemplate>
        <uc:OkMessageBox ID="omb" runat="server" />
        <div class="TituloLabel" id="HeadRIMI" runat="server">
                    <asp:Label ID="Ltitulo" runat="server" ForeColor="White" Text="Reporte Indicadores Metas Incumplidas" Font-Bold="False"
        ...
        <div id="BodyGridRIMC" class="ColumnStyle" runat="server" visible="false">
            <Table class="tabla" align="center" width="100%">
                        <tr align="center">
                            <td>
                                <asp:GridView ID="GVIndicadoresMetasIncumplidas" runat="server" CellPadding="4"
                                    ForeColor="#333333" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                    ShowHeaderWhenEmpty="True" 
                                    HeaderStyle-CssClass="gridViewHeader" BorderStyle="Solid" GridLines="Vertical"
                                    CssClass="Apariencia" Font-Bold="False" OnPreRender="GVIndicadoresMetasIncumplidas_PreRender">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Cantidad Metas Incumplidas" ItemStyle-HorizontalAlign="Left">
                                            <ItemTemplate>
                                                <div style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 50px">
                                                    <asp:Label ID="intMetasIncumplidas" runat="server" Text='<% # Bind("intMetasIncumplidas")%>'></asp:Label>
                                                </div>
                                            </ItemTemplate>
                                            <HeaderStyle Wrap="false"  HorizontalAlign="center" />
                                            <ItemStyle Wrap="false" />
