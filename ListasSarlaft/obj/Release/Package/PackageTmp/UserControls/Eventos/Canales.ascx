<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Canales.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.Canales" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[Canal] WHERE [IdCanal] = @IdCanal"
    InsertCommand="INSERT INTO [Eventos].[Canal] ([Descripcion], [IdUsuario], [FechaRegistro]) VALUES (@Descripcion, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdCanal], [Descripcion], [Usuario],  CONVERT(VARCHAR(10),[FechaRegistro],103) AS FechaRegistro FROM [Eventos].[Canal], [Listas].[Usuarios] WHERE [Canal].[IdUsuario] = [Usuarios].[IdUsuario]"
    UpdateCommand="UPDATE [Eventos].[Canal] SET [Descripcion] = @Descripcion WHERE [IdCanal] = @IdCanal">
    <DeleteParameters>
        <asp:Parameter Name="IdCanal" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Canales" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdCanal,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ShowHeaderWhenEmpty="True" OnRowCommand="GridView1_RowCommand"
                                    HeaderStyle-CssClass="gridViewHeader" BorderStyle="Solid" GridLines="Vertical"
                                    CssClass="Apariencia" Font-Bold="False">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField DataField="IdCanal" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdCanal">
