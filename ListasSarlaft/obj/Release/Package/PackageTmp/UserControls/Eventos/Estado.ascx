<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Estado.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.Estado" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[Estado] WHERE [IdEstado] = @IdEstado"
    InsertCommand="INSERT INTO [Eventos].[Estado] ([Descripcion], [IdUsuario], [FechaRegistro]) VALUES (@Descripcion, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdEstado], [Descripcion], [Usuario],  CONVERT(VARCHAR(10),[FechaRegistro],103) AS FechaRegistro FROM [Eventos].[Estado], [Listas].[Usuarios] WHERE [Estado].[IdUsuario] = [Usuarios].[IdUsuario]"
    UpdateCommand="UPDATE [Eventos].[Estado] SET [Descripcion] = @Descripcion WHERE [IdEstado] = @IdEstado">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Estado" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdEstado,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ShowHeaderWhenEmpty="True" OnRowCommand="GridView1_RowCommand"
                                    HeaderStyle-CssClass="gridViewHeader" BorderStyle="Solid" GridLines="Vertical"
                                    CssClass="Apariencia" Font-Bold="False">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField DataField="IdEstado" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdEstado">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ControlToValidate="txtNombre"
                                    ...
                                    ValidationGroup="iEstado" ForeColor="Red">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iEstado" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iEstado" />
                                        </td>
                                        <td>
