<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RptObjetivosEstrategicos.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Gestion.RptObjetivosEstrategicos" %>
    ...
    <ContentTemplate>
        <table align="center">
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label7" runat="server" ForeColor="White" Text="Reporte Objetivos Estratégicos"
            ...
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                        ...
                        <LocalReport ReportPath="Reportes\RptObjetivosEstrategicos.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="SqlDataSourceObjetivosEstrategicos" Name="DataSetObjetivoEstrategico" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:SqlDataSource ID="SqlDataSourceObjetivosEstrategicos" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
                        SelectCommand="SP_ObjetivosEstrategicos" SelectCommandType="StoredProcedure">
                        <SelectParameters>
