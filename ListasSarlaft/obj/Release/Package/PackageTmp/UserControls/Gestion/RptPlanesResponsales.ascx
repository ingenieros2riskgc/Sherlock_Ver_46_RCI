<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RptPlanesResponsales.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Gestion.RptPlanesResponsales" %>
    ...
    <ContentTemplate>
        <table align="center">
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label7" runat="server" ForeColor="White" Text="Reporte Planes de Acción por Responsable"
            ...
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                        ...
                        <LocalReport ReportPath="Reportes\RptPlanesResponsales.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="SqlDataSourcePlanesResponsales" Name="DataSetRptPlanesResponsales" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:SqlDataSource ID="SqlDataSourcePlanesResponsales" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
                        SelectCommand="SP_PlanesAccionResponsables" SelectCommandType="StoredProcedure">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="TextBox8" DefaultValue="0" Name="IdPlan" PropertyName="Text"
                                Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </td>
