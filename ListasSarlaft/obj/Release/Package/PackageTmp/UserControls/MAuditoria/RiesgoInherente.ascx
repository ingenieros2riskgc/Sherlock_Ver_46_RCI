<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RiesgoInherente.ascx.cs"
    Inherits="ListasSarlaft.UserControls.MAuditoria.RiesgoInherente" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Auditoria].[RiesgoInherente] WHERE [IdRiesgoInherente] = @IdRiesgoInherente"
    InsertCommand="INSERT INTO [Auditoria].[RiesgoInherente] ([Descripcion], [FechaRegistro], [IdUsuario]) VALUES (@Descripcion, @FechaRegistro, @IdUsuario)"
    SelectCommand="SELECT [IdRiesgoInherente], [Descripcion], CONVERT(VARCHAR(10),[RiesgoInherente].[FechaRegistro],120) AS FechaRegistro, [RiesgoInherente].[IdUsuario], [Usuarios].IdUsuario as CodigoUsuario 
                   FROM   [Auditoria].[RiesgoInherente], [Listas].[Usuarios]
                   WHERE  [Usuarios].IdUsuario = [RiesgoInherente].IdUsuario"
    UpdateCommand="UPDATE [Auditoria].[RiesgoInherente] SET [Descripcion] = @Descripcion WHERE [IdRiesgoInherente] = @IdRiesgoInherente">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center" width="100%">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Riesgo Inherente"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdRiesgoInherente,CodigoUsuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ShowHeaderWhenEmpty="True" OnRowCommand="GridView1_RowCommand" HeaderStyle-CssClass="gridViewHeader"
                                    BorderStyle="Solid" GridLines="Vertical" CssClass="Apariencia" Font-Bold="False">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField DataField="IdRiesgoInherente" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdRiesgoInherente">
                ...
                <td bgcolor="#EEEEEE">
                    <table class="tabla" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDescripcion" runat="server" Width="400px" CssClass="Apariencia"
                                    Rows="1"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
