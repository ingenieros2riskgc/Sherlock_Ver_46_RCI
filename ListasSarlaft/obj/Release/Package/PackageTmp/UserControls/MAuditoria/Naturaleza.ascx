<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Naturaleza.ascx.cs" Inherits="ListasSarlaft.UserControls.MAuditoria.Naturaleza" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Auditoria].[Naturaleza] WHERE [IdNaturaleza] = @IdNaturaleza"
    InsertCommand="INSERT INTO [Auditoria].[Naturaleza] ([Descripcion], [FechaRegistro], [IdUsuario]) VALUES (@Descripcion, @FechaRegistro, @IdUsuario)"
    SelectCommand="SELECT [IdNaturaleza], [Descripcion], CONVERT(VARCHAR(10),[Naturaleza].[FechaRegistro],103) AS FechaRegistro, [Naturaleza].[IdUsuario], [Usuarios].CodigoUsuario
                    FROM [Auditoria].[Naturaleza], [Parametrizacion].[Usuarios]
                    WHERE 
                          [Usuarios].IdUsuario = [Naturaleza].IdUsuario"
    UpdateCommand="UPDATE [Auditoria].[Naturaleza] SET [Descripcion] = @Descripcion WHERE [IdNaturaleza] = @IdNaturaleza">
    <DeleteParameters>
        <asp:Parameter Name="IdNaturaleza" Type="Int64" />
    </DeleteParameters>
    <InsertParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center"  width="100%">
            ...
            <tr align="center" bgcolor="Red">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Naturaleza" Font-Bold="False"
                        ...
                        <tr >
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdNaturaleza,CodigoUsuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ShowHeaderWhenEmpty="True" onrowcommand="GridView1_RowCommand"
                                    HeaderStyle-CssClass="gridViewHeader" BorderStyle="Solid" GridLines="Vertical"
                                    CssClass="Apariencia" Font-Bold="False">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField DataField="IdNaturaleza" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdNaturaleza" >
