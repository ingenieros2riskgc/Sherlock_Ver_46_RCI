<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Estandar.ascx.cs" Inherits="ListasSarlaft.UserControls.MAuditoria.Estandar" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Auditoria].[Estandar] WHERE [IdEstandar] = @IdEstandar"
    InsertCommand="INSERT INTO [Auditoria].[Estandar] ([IdTipoEstandar], [IdUsuario], [Nombre], [Descripcion], [FechaRegistro]) VALUES (@IdTipoEstandar, @IdUsuario, @Nombre, @Descripcion, @FechaRegistro)"
    SelectCommand="SELECT [IdEstandar], [Estandar].[IdTipoEstandar] AS IdTipoEstandar, [TipoEstandar].[Descripcion] as DescripcionTipoEstandar, [Estandar].[IdUsuario], [Usuario],  [Estandar].[Nombre], [Estandar].[Descripcion], CONVERT(VARCHAR(10),[Estandar].[FechaRegistro],120) AS FechaRegistro 
                   FROM   [Auditoria].[Estandar], [Auditoria].[TipoEstandar], [Listas].[Usuarios] 
                   WHERE  [Estandar].[IdTipoEstandar] = [TipoEstandar].[IdTipoEstandar] AND 
                          [Estandar].[idUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Auditoria].[Estandar] SET [IdTipoEstandar] = @IdTipoEstandar, [Nombre] = @Nombre, [Descripcion] = @Descripcion WHERE [IdEstandar] = @IdEstandar">
    <DeleteParameters>
        <asp:Parameter Name="IdEstandar" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
        <asp:Parameter Name="IdTipoEstandar" Type="Int32" />
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server" 
    ...
    SelectCommand="SELECT [IdTipoEstandar], [Descripcion] FROM [Auditoria].[TipoEstandar]"></asp:SqlDataSource>
    ...
    <ContentTemplate>
        ...
        <table align="center"  width="100%">
                <tr align="center" bgcolor="#333399">
                    <td>
                        <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Estándar" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    ShowHeaderWhenEmpty="True" HeaderStyle-CssClass="gridViewHeader" DataKeyNames="Usuario,IdTipoEstandar,Descripcion"
                                    BorderStyle="Solid" GridLines="Vertical" CssClass="Apariencia" 
                                    Font-Bold="False" onrowcommand="GridView1_RowCommand">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField DataField="IdEstandar" HeaderText="Código" InsertVisible="False" ReadOnly="True"
                                            SortExpression="IdEstandar" >
                                        <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="IdTipoEstandar" HeaderText="IdTipoEstandar" 
                                            SortExpression="IdTipoEstandar" InsertVisible="False" ReadOnly="True" 
                                            Visible="False" />
                                        <asp:BoundField DataField="DescripcionTipoEstandar" HeaderText="Tipo de Estándar" 
                                            SortExpression="DescripcionTipoEstandar" >
                                        ...
                                        <asp:BoundField DataField="Nombre" HeaderText="Estándar" 
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#EEEEEE">
                        ...
                        <table  class="tabla" width="100%">
                            ...
                            <tr>
                                <td align="left" bgcolor="#BBBBBB">
                                    <asp:Label ID="Label3" runat="server" Text="Tipo de Estándar:" CssClass="Apariencia"></asp:Label>
                                </td>
                                <td>
                                    <asp:DropDownList ID="ddlTipoEstandar" runat="server" Width="300px" 
                                        CssClass="Apariencia" DataSourceID="SqlDataSource2" 
                                        DataTextField="Descripcion" DataValueField="IdTipoEstandar" 
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtNombre" runat="server" Width="400px" CssClass="Apariencia" 
                                        Rows="3"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
