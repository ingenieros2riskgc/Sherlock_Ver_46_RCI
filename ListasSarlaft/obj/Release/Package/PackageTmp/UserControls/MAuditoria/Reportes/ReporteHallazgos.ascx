<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReporteHallazgos.ascx.cs"
    Inherits="ListasSarlaft.UserControls.MAuditoria.Reportes.ReporteHallazgos" %>
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label140" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Reportes Hallazgos"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Tipo de Hallazgo" DataField="Tipo de Hallazgo" />
                                        <asp:BoundField HeaderText="Estado del Hallazgo" DataField="Estado del Hallazgo" />
