<%@ Page Title="Sherlock" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MastersPages/Admin.Master" AutoEventWireup="true"
    CodeBehind="ConsultarFormClienteCopidrogas.aspx.cs" Inherits="ListasSarlaft.Formularios.Admin.ConsultarFormClienteCopidrogas" %>

<%@ OutputCache Location="None" %>

<%@ Register TagPrefix="CCCFC" TagName="ConsultarFormCliente1" Src="~/UserControls/Sarlaft/ConsultarFormClienteCopidrogas.ascx" %>
