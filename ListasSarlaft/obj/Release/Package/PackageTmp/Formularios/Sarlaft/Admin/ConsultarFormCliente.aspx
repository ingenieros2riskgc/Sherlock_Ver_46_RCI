<%@ Page Title="Sherlock" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MastersPages/Admin.Master" AutoEventWireup="true"
    CodeBehind="ConsultarFormCliente.aspx.cs" Inherits="ListasSarlaft.Formularios.Admin.ConsultarFormCliente" %>

<%@ OutputCache Location="None" %>

<%@ Register TagPrefix="CCCFC" TagName="ConsultarFormCliente1" Src="~/UserControls/Sarlaft/ConsultarFormCliente.ascx" %>
