<%@ Page Title="Sherlock" MaintainScrollPositionOnPostback="true" Language="C#" MasterPageFile="~/MastersPages/Admin.Master" AutoEventWireup="true"
    CodeBehind="AdminFormClienteWillisFCC.aspx.cs" Inherits="ListasSarlaft.Formularios.Admin.AdminFormClienteWillisFCC" %>

<%@ OutputCache Location="None" %>

<%@ Register TagPrefix="CCFC" TagName="FormCliente1" Src="~/UserControls/Sarlaft/FormClienteWillisFCC.ascx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <CCFC:FormCliente1 ID="FormCliente2" runat="server" />
</asp:Content>
