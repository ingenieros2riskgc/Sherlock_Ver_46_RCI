...
{
    public partial class ReporteIndicadoresMetasCumplidas : System.Web.UI.UserControl
    {
        string IdFormulario = "4035";
        ...
        private bool mtdLoadIndicador(ref string strErrMsg, ref string fechaInicial, ref string fechaFinal)
        {
            ...
            #endregion Vars
            lstMatriz = cMatriz.mtdConsultarIndicadorCumplido(ref strErrMsg, ref fechaInicial, ref fechaFinal);
            ...
            if (lstMatriz != null && lstMatriz.Count > 0)
            {
                ...
                /*foreach (clsMatrizIndicadores objMatriz2 in lstMatriz)
                {
                    ...
                    {*/
                        ...
                        GVIndicadoresMetasCumplidas.DataSource = lstMatriz;
                        GVIndicadoresMetasCumplidas.PageIndex = pagIndex1;
                        GVIndicadoresMetasCumplidas.DataBind();
                        booResult = true;
        ...
        private void mtdLoadIndicador()
        {
            ...
            GVIndicadoresMetasCumplidas.DataSource = grid;
            GVIndicadoresMetasCumplidas.DataBind();
            InfoGrid1 = grid;
        }
        /// <summary>
        ...
        protected void GVIndicadoresMetasCumplidas_PreRender(object sender, EventArgs e)
        {
            MergeRowsMatrizData(GVIndicadoresMetasCumplidas);
        }
        ...
        private void mtdExportPdf()
        {
            ...
            PdfPTable pdfpTableCumplimiento = tools.createPdftable(GVIndicadoresMetasCumplidas);



            foreach (GridViewRow GridViewRow in GVIndicadoresMetasCumplidas.Rows)
            {
            ...
            pdfDocument.Add(new Phrase(""));
            pdfDocument.Add(Chunk.NEWLINE);
            Paragraph Titulo = new Paragraph(new Phrase("Reporte de Indicadores Metas Cumplidas"));
            ...
            Response.AddHeader("content-disposition", "attachment;filename=ReporteIndicadoresMetasCumplidas.pdf");
