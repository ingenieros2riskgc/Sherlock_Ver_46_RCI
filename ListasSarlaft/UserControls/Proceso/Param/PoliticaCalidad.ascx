<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PoliticaCalidad.ascx.cs" Inherits="ListasSarlaft.UserControls.Proceso.PoliticaCalidad" %>
    ...
    <ContentTemplate>
        ...
        <table align="center" width="80%">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Política de Calidad" Font-Bold="False"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvDescripcion" runat="server" ControlToValidate="tbxDescripcion"
                                    ...
                                    ValidationGroup="iPolitica" ForeColor="Red">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iPolitica" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                ...
                                                ToolTip="Guardar" ValidationGroup="iPolitica" />
                                        </td>
                                        <td>
