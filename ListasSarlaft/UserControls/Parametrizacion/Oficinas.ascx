                ...
                <td bgcolor="#EEEEEE">
                    <table  class="tabla" width="100%">
                        ...
                        <tr>
                         ...
                         <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                <asp:Label ID="Label8" runat="server" Text="Ciudad:" CssClass="Apariencia"></asp:Label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Oficina / Sucursal:" CssClass="Apariencia"></asp:Label>
                            </td>
                            <td>
