...
{
    public partial class OtrosFactores : System.Web.UI.UserControl
    {
        ...
        protected void btnImgokEliminar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                SqlDataSource1.DeleteParameters["IdOtrosFactores"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
        ...
        protected void btnImgActualizar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            else
            {
                if (VerificarCampos())
                {
                    try
                    {
                        SqlDataSource1.UpdateParameters["IdOtrosFactores"].DefaultValue = Sanitizer.GetSafeHtmlFragment(txtId.Text.Trim());
