<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OtrosFactores.ascx.cs" Inherits="ListasSarlaft.UserControls.MAuditoria.OtrosFactores" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Auditoria].[OtrosFactores] WHERE [IdOtrosFactores] = @IdOtrosFactores"
    InsertCommand="INSERT INTO [Auditoria].[OtrosFactores] ([Descripcion], [FechaRegistro], [IdUsuario]) VALUES (@Descripcion, @FechaRegistro, @IdUsuario)"
    SelectCommand="SELECT [IdOtrosFactores], [Descripcion], CONVERT(VARCHAR(10),[OtrosFactores].[FechaRegistro],103) AS FechaRegistro, [OtrosFactores].[IdUsuario], [Usuarios].Usuario
                    FROM [Auditoria].[OtrosFactores], [Listas].[Usuarios]
                    WHERE 
                          [Usuarios].IdUsuario = [OtrosFactores].IdUsuario"
    
    UpdateCommand="UPDATE [Auditoria].[OtrosFactores] SET [Descripcion] = @Descripcion WHERE [IdOtrosFactores] = @IdOtrosFactores">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center"  width="100%">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Otros Factores de Consideración" Font-Bold="False"
                        ...
                        <tr >
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdOtrosFactores,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ShowHeaderWhenEmpty="True" onrowcommand="GridView1_RowCommand"
                                    HeaderStyle-CssClass="gridViewHeader" BorderStyle="Solid" GridLines="Vertical"
                                    CssClass="Apariencia" Font-Bold="False">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField DataField="IdOtrosFactores" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdOtrosFactores" >
                ...
                <td bgcolor="#EEEEEE">
                        ...
                        <table class="tabla" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtDescripicion" runat="server" Width="800px" CssClass="Apariencia"
                                    ...
                                    <%--<asp:HtmlEditorExtender ID="htmlEDescripcion" runat="server"
                                        Enabled="True" TargetControlID="txtDescripicion">
                                        <Toolbar> 
                                                        <asp:Undo />
                                                        <asp:Redo />
                                                        <asp:Bold/>
