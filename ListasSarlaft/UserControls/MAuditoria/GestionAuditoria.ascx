                    ...
                    <table align="center" width="100%">
                        ...
                        <tr id="filaTabGestion" runat="server" bgcolor="#EEEEEE" visible="false">
                            <td>
                                ...
                                <br />
                                <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="6" AutoPostBack="True"
                     ...
                     <tr align="center">
                         <td>
                             <table>
                                 <tr>
                                     <td>
                                         <asp:ImageButton ID="btnImgCancelarAdjunto" runat="server" ImageUrl="~/Imagenes/Icons/cancel.png"
            ...
            <td>
                ...
                <table class="tabla">
                    <tr align="left">
                        ...
                        <td>
                            <asp:FileUpload ID="fuCargueArchivos" runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td bgcolor="#BBBBBB">
