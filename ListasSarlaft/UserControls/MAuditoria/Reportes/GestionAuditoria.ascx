<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GestionAuditoria.ascx.cs"
    Inherits="ListasSarlaft.UserControls.MAuditoria.Reportes.GestionAuditoria" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table align="center" width="100%" bgcolor="#EEEEEE">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label140" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Reportes Gestión Auditoría"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Button ID="Button13" runat="server" Text=">>" Height="20px" Width="30px" Font-Names="Calibri"
                                                Font-Size="Small" ToolTip="Seleccionar todos" OnClick="Button13_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Button ID="Button14" runat="server" Text=">" Height="20px" Width="30px" Font-Names="Calibri"
                                                Font-Size="Small" ToolTip="Seleccionar uno" OnClick="Button14_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Button ID="Button15" runat="server" Text="<<" Height="20px" Width="30px" Font-Names="Calibri"
                                                Font-Size="Small" ToolTip="Quitar todos" OnClick="Button15_Click" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Button ID="Button16" runat="server" Text="<" Height="20px" Width="30px" Font-Names="Calibri"
                                                Font-Size="Small" ToolTip="Quitar uno" OnClick="Button16_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
            ...
            <tr>
                <td>
                    <table runat="server" id="TbNdetalle" align="center" visible="false">
                        <tr>
                            <td>
                                <br />
                            </td>
                        ...
                        <tr align="center">
                            <td bgcolor="#5D7B9D">
                                <asp:Label ID="Label8" runat="server" Text="Nivel de Detalle" Font-Names="Calibri"
                                    Font-Size="Small" ForeColor="White"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:DropDownList ID="DropDownList1" runat="server" Font-Names="Calibri" Font-Size="Small">
                                    ...
                                    <asp:ListItem Value="1">Estado Actual</asp:ListItem>
                                    <asp:ListItem Value="2">Histórico de Auditoría</asp:ListItem>
                                </asp:DropDownList>
                                <asp:CompareValidator ID="CompareValidator1" runat="server" ForeColor="Red" ControlToValidate="DropDownList1"
                                    ValidationGroup="Filtro" ValueToCompare="---" Operator="NotEqual">*</asp:CompareValidator>
                            </td>
                        </tr>
                    </table>
                </td>
                        ...
                        <tr>
                            <td>
                                <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Imagenes/Icons/lupa.png"
                                    ToolTip="Ver Reportes" ValidationGroup="Filtro" OnClick="ImageButton1_Click" />
                            </td>
                            <td>
            ...
            <tr>
                <td>
                    <table id="TblReporte" runat="server" visible="false" align="center" class="tablaSinBordes">
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Dependencia / Proceso" DataField="Dependencia / Proceso" />
                                        ...
                                        <asp:BoundField HeaderText="Tiempo Estimado" DataField="Tiempo Estimado">
                                            <ItemStyle Width="30px" HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="Recurso" DataField="Recurso" />
                                        <asp:BoundField HeaderText="Etapa" DataField="Etapa" />
                                        <%--<asp:BoundField HeaderText="Estado Actual" DataField="Estado Actual" />--%>
                                        <asp:BoundField HeaderText="Fecha inicio Etapa" DataField="Fecha inicio Etapa" />
                                        <asp:BoundField HeaderText="Fecha Fin Etapa" DataField="Fecha Fin Etapa" />
                                        <asp:BoundField HeaderText="Horas asignadas por Etapa" DataField="Horas asignadas por Etapa">
                                            <ItemStyle HorizontalAlign="Center" Width="50px" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="Fecha inicio Etapa Real" DataField="Fecha inicio Etapa Real" />
                                        <asp:BoundField HeaderText="Fecha Fin Etapa Real" DataField="Fecha Fin Etapa Real" />
                                        <asp:BoundField HeaderText="Diferencia en Días" DataField="Diferencia en Días">
                                            <ItemStyle Width="30px" HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:TemplateField HeaderText="Color">
                                            <ItemTemplate>
                                                <asp:Image ID="Image1" runat="server" Width="25px" />
                                            </ItemTemplate>
                                            <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Wrap="False" />
                                        </asp:TemplateField>
                                        <%--<asp:BoundField HeaderText="Devuelta" DataField="Devuelta" Visible="False">
