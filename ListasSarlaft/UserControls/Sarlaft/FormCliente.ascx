<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FormCliente.ascx.cs"
    Inherits="ListasSarlaft.UserControls.FormCliente" %>
                                            ...
                                            <td>
                                                <table width="100%">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="TextBox13" runat="server" MaxLength="20" Width="180px"></asp:TextBox>
                                                        </td>
                                                        <td >
                                                            <asp:Label ID="Label24" runat="server" Text="OCUPACIÓN / OFICIO   "></asp:Label>
                                                            <asp:DropDownList ID="DropDownList6" runat="server" Width="189px">
                                                                <asp:ListItem>---</asp:ListItem>
                                            ...
                                            <td>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="TxtPNCorreoElectronico" runat="server" MaxLength="100" Width="450px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Label ID="Label114" runat="server" Text="b. Tanto mi actividad, profesión u oficio es lícita y la ejerzo dentro del marco legal y los recursos que poseo no provienen de actividades ilícitas de las contempladas en el Código Penal Colombiano."></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Label ID="Label115" runat="server" Text="c. La información que he suministrado en la solicitud y en este documento es veraz y verificable y me obligo a actualizarla anualmente."></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Label ID="Label116" runat="server" Text="d. De manera irrevocable autorizo a las compañías de Seguros, Sociedades de Capitalización e Intermediarios de Seguros, con los que mantenga una relación comercial vigente para solicitar, consultar, procesar, suministrar, reportar o divulgar a cualquier entidad válidamente autorizada para manejar o administrar bases de datos, incluidas las entidades gubernamentales, información contenida en este formulario."></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <asp:Label ID="Label117" runat="server" Text="e. Los recursos que se deriven del desarrollo de este contrato no se destinaran a la financiación del terrorismo, grupos terroristas o actividades terroristas."></asp:Label>
                                                            <br />
                                                            f. Autorizo de manera permanente e irrevocable a Seguros del Estado S.A. y Seguros
                                                            de Vida del Estado S.A. o a quien represente sus derechos para que con fines estadísticos,
                                                            de control, supervisión y de información comercial a otras entidades, procese, reporte,
                                                            conserve, consulte, suministre o actualice cualquier información de carácter financiero,
                                                            comercial, crediticio y personal desde el momento de la solicitud de seguro o vinculación,
                                                            a las centrales de información o bases de datos debidamente constituidas que estime
                                                            conveniente, en los términos y durante el tiempo que los sistemas de bases de datos,
                                                            las normas y las autoridades lo establezcan<br />
                                                            La consecuencia de esta autorización sera la inclusión de mi información en las
                                                            mencionadas bases de datos y por tanto las entidades del sector financiero, asegurador
                                                            o de cualquier otro sector afiliadas a dichas centrales conocerán mi comportamiento
                                                            presente y pasado relacionado con mis obligaciones financieras, comerciales, crediticias
                                                            y personales o cualquier otro dato personal o económico que estime pertinente.
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr valign="top">
                                            <td>
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label122" runat="server" Text="* Constancia de ingresos (Honorarios laborales, Certificado de Ingresos y Retenciones o el documento que corresponda)."></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label123" runat="server" Text="* Declaración de Renta del último período gravable disponible. (Si declara)"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label124" runat="server" Text="* Inventario general de los bienes objeto del seguro salvo cuando se trate de pólizas flotantes o automáticas."></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label132" runat="server" Text="* Original del Certificado de Existencia y Representación Legal con vigencia no superior a (3) meses, expedido por la Camara de Comercio."></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label133" runat="server" Text="* Fotocopia del Registro Único Tributario (RUT), el cual puede ser obtenido directamente por la entidad vigilada."></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label129" runat="server" Text="* Fotocopia del documento de identificación del Representante Legal."></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label130" runat="server" Text="* Inventario general de los bienes objeto del seguro, salvo cuando se trate de pólizas flotantes o automáticas."></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label131" runat="server" Text="* Declaración de Renta del último período gravable disponible (Si declara) o estados financieros."></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td class="style6">
                                                            <asp:Label ID="Label134" runat="server" Text="* APODERADO 1. En caso de que el cliente se presente a través de apoderado debe anexar poder debidamente firmado con reconocimiento de texto y firma ante notaria"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                            ...
                                            <td>
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label205" runat="server" Text="* Documentación según políticas vigentes de la compañía"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                        ...
                                        <tr>
                                            <td align="center" valign="top" style="width: 80%;">
                                                <table>
                                                    <tr>
                                                        <td class="style7">
                                                            COMO CONSTANCIA DE HABER LEÍDO, ENTENDIDO Y ACEPTADO LO ANTERIOR, FIRMO EL PRESENTE
                                                            DOCUMENTO<br />
                                                            <asp:Label ID="Label148" runat="server" Text="Y ESTARÉ DISPUESTO A LA VERIFICACIÓN DEL MISMO DECLARO QUE LA INFORMACIÓN"></asp:Label>
                                                            <br />
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table>
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Label ID="Label152" runat="server" Text="DIRECCION DE LA ENTREVISTA"></asp:Label>
                                                                                </td>
                                                                                <td>
                                                                                    <asp:TextBox ID="TextBox94" runat="server" MaxLength="20" Width="266px"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                                                        ...
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <asp:CalendarExtender ID="CalendarExtender5" runat="server" TargetControlID="TextBox95"
                                                                                        Format="dd-MMM-yyyy">
                                                                                    </asp:CalendarExtender>
                                                                                </td>
                                                                                <td>
                                                                        ...
                                                                        <table>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <asp:CalendarExtender ID="CalendarExtender6" runat="server" TargetControlID="TextBox100"
                                                                                        Format="dd-MMM-yyyy">
                                                                                    </asp:CalendarExtender>
                                                                                </td>
                                                                                <td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table>
                                                                            <tr>
                                                                                <td>
                                                                                    <asp:Label ID="Label163" runat="server" Text="SUCURSAL"></asp:Label>
                                                                                </td>
                                                                                <td>
                                                                                    <asp:TextBox ID="TextBox104" runat="server" MaxLength="200" Width="361px"></asp:TextBox>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
                                                                    </td>
                                        ...
                                        <tr align="left">
                                            <td>
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label178" runat="server" Text="Nombre y/o identificación no consistentes con soportes"
                                                                Font-Names="Calibri" Font-Size="Small"></asp:Label>
                                                        </td>
                                                        <td>
                                                            <asp:DropDownList ID="DropDownList39" runat="server" Font-Names="Calibri" Font-Size="Small">
                                                                <asp:ListItem>NO</asp:ListItem>
                                                                <asp:ListItem>SI</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label179" runat="server" Text="Nombre de representante legal no coincide con cámara de comercio"
                                                                Font-Names="Calibri" Font-Size="Small"></asp:Label>
                                                        </td>
                                                        <td>
                                        ...
                                        <tr align="left">
                                            <td>
                                                <table>
                                                    <tr>
                                                        <td colspan="2" align="center">
                                                            <asp:Label ID="Label188" runat="server" Text="PERSONA NATURAL" Font-Names="Calibri"
                                                                Font-Size="Small"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" align="center">
                                                            <asp:Label ID="Label189" runat="server" Text="PERSONA JURIDICA" Font-Names="Calibri"
                                                                Font-Size="Small"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="Label190" runat="server" Text="Documentación según políticas vigentes de la compañía"
                                                                Font-Names="Calibri" Font-Size="Small"></asp:Label>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr align="center">
                                                        <td colspan="2">
                                                            <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                                ToolTip="Guardar" OnClick="ImageButton2_Click" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
