...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table align="center" bgcolor="#EEEEEE">
                            ...
                            <td colspan="2">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Button ID="btn_Exportar" runat="server" Text="Interface" Font-Names="Calibri" Font-Size="Small" Width="100px" Height="40px" OnClick="btn_Exportar_Click" />
                                        </td>
                                        <td>
                                            <asp:Button ID="btn_Reporte" runat="server" Text="Reporte" Font-Names="Calibri" Font-Size="Small" Width="100px" Height="40px" OnClick="btn_Reporte_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                    ...
                    <tr id="TrGvResultados" runat="server" visible="false">
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4"
                                    ...
                                    AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging" Font-Bold="False">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:ButtonField ButtonType="Image" Text="Aprobar" CommandName="Modificar" HeaderText="Aprobar" ImageUrl="~/Imagenes/Icons/apply.png" >
                                        <ItemStyle HorizontalAlign="Center" />
                                        </asp:ButtonField>
                                        <asp:ButtonField ButtonType="Image" Text="Imprimir" CommandName="Imprimir" HeaderText="Imprimir" ImageUrl="~/Imagenes/Icons/print.png" >
                                        <ItemStyle HorizontalAlign="Center" />
                                        </asp:ButtonField>
                                        <asp:ButtonField ButtonType="Image" Text="Consultar" CommandName="Consultar" HeaderText="Consultar" ImageUrl="~/Imagenes/Icons/auditoria3.png" >
                                        <ItemStyle HorizontalAlign="Center" />
                                        </asp:ButtonField>
                                    </Columns>
            ...
            <tr runat="server" id="trIframe" align="center" visible="false">
                <td align="center">
                    <br />
                    <iframe runat="server" id="Iframe_FCC" style="width: 1200px; height: 1200px; border: none;"></iframe>
    ...
    <Triggers>
        ...
        <asp:PostBackTrigger ControlID="btn_Reporte" />
    </Triggers>
</asp:UpdatePanel>
