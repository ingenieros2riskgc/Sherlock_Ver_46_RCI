<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SubClase.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.SubClase" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[SubClase] WHERE [IdSubClase] = @IdSubClase"
    InsertCommand="INSERT INTO [Eventos].[SubClase] ([IdClase], [IdUsuario], [SubDescripcion], [FechaRegistro]) VALUES (@IdClase, @IdUsuario, @SubDescripcion, @FechaRegistro)"
    SelectCommand="SELECT [IdSubClase], [Clase].[IdClase] AS IdClase, [SubDescripcion], [Clase].[IdUsuario], [Usuario], [Descripcion], CONVERT(VARCHAR(10),[SubClase].[FechaRegistro],103) AS FechaRegistro FROM [Eventos].[SubClase], [Eventos].[Clase], [Listas].[Usuarios] WHERE [Clase].[IdClase] = [SubClase].[IdClase] AND [Clase].[idUsuario] = [Usuarios].[idUsuario]"
    UpdateCommand="UPDATE [Eventos].[SubClase] SET [IdClase] = @IdClase, [SubDescripcion] = @SubDescripcion WHERE [IdSubClase] = @IdSubClase">
    <DeleteParameters>
        <asp:Parameter Name="IdSubClase" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
...
<asp:SqlDataSource ID="SqlDataSource2" runat="server"
    ...
    SelectCommand="SELECT [IdClase], [Descripcion] FROM [Eventos].[Clase]"></asp:SqlDataSource>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="SubClases de Evento" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    ShowHeaderWhenEmpty="True" HeaderStyle-CssClass="gridViewHeader" DataKeyNames="Usuario,IdClase"
                                    BorderStyle="Solid" GridLines="Vertical" CssClass="Apariencia"
                                    Font-Bold="False" OnRowCommand="GridView1_RowCommand">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField DataField="IdSubClase" HeaderText="Código" InsertVisible="False" ReadOnly="True"
                                            SortExpression="IdSubClase">
                                            <ItemStyle HorizontalAlign="Center" />
                                        </asp:BoundField>
                                        <asp:BoundField DataField="IdClase" HeaderText="IdClase"
                                            SortExpression="IdClase" InsertVisible="False" ReadOnly="True"
                                            Visible="False" />
                                        ...
                                        <asp:BoundField DataField="SubDescripcion" HeaderText="SubClase"
            ...
            <tr align="left" id="filaDetalle" runat="server" visible="false">
                <td bgcolor="#EEEEEE">
                    <table width="100%">
                        ...
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Clase:" CssClass="Apariencia"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlClase" runat="server" Width="300px"
                                    CssClass="Apariencia" DataSourceID="SqlDataSource2" OnDataBound="ddlClase_DataBound"
                                    DataTextField="Descripcion" DataValueField="IdClase" AppendDataBoundItems="true">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rfvClase" runat="server" ControlToValidate="ddlClase"
                                    ErrorMessage="Debe ingresar la clase." ToolTip="Debe ingresar la clase."
                                    ValidationGroup="iClase" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ValidationGroup="iClase"
                                                ToolTip="Guardar" />
                                        </td>
                                        <td>
