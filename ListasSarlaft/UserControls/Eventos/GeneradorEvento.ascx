<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GeneradorEvento.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.GeneradorEvento" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[Generador] WHERE [IdGenerador] = @IdGenerador"
    InsertCommand="INSERT INTO [Eventos].[Generador] ([Descripcion], [IdUsuario], [FechaRegistro]) VALUES (@Descripcion, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdGenerador], [Descripcion], [Usuario],  CONVERT(VARCHAR(10),[FechaRegistro],103) AS FechaRegistro FROM [Eventos].[Generador], [Listas].[Usuarios] WHERE [Generador].[IdUsuario] = [Usuarios].[IdUsuario]"
    UpdateCommand="UPDATE [Eventos].[Generador] SET [Descripcion] = @Descripcion WHERE [IdGenerador] = @IdGenerador">
    <DeleteParameters>
        <asp:Parameter Name="IdGenerador" Type="Int32" />
    </DeleteParameters>
    <InsertParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Generador Evento" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdGenerador,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ShowHeaderWhenEmpty="True" OnRowCommand="GridView1_RowCommand"
                                    HeaderStyle-CssClass="gridViewHeader" BorderStyle="Solid" GridLines="Vertical"
                                    CssClass="Apariencia" Font-Bold="False">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField DataField="IdGenerador" HeaderText="Código" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdGenerador">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ControlToValidate="txtNombre"
                                    ...
                                    ValidationGroup="iGEv" ForeColor="Red">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iGEv" />
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iGEv" />
                                        </td>
                                        <td>
