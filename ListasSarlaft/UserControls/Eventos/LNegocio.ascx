<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LNegocio.ascx.cs" Inherits="ListasSarlaft.UserControls.Eventos.LNegocio" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
    DeleteCommand="DELETE FROM [Eventos].[LineaNegocio] WHERE [IdLineaNegocio] = @IdLineaNegocio"
    InsertCommand="INSERT INTO [Eventos].[LineaNegocio] ([Descripcion], [IdUsuario], [FechaRegistro]) VALUES (@Descripcion, @IdUsuario, @FechaRegistro)"
    SelectCommand="SELECT [IdLineaNegocio], [Descripcion], [Usuario],  CONVERT(VARCHAR(10),[FechaRegistro],103) AS FechaRegistro FROM [Eventos].[LineaNegocio], [Listas].[Usuarios] WHERE [LineaNegocio].[IdUsuario] = [Usuarios].[IdUsuario]"
    UpdateCommand="UPDATE [Eventos].[LineaNegocio] SET [Descripcion] = @Descripcion WHERE [IdLineaNegocio] = @IdLineaNegocio">
    <DeleteParameters>
    ...
    <ContentTemplate>
        ...
        <table align="center">
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label13" runat="server" ForeColor="White" Text="Línea Operativa" Font-Bold="False"
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" CellPadding="4" DataSourceID="SqlDataSource1"
                                    ...
                                    DataKeyNames="IdLineaNegocio,Usuario" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
                                    ShowHeaderWhenEmpty="True" OnRowCommand="GridView1_RowCommand"
                                    HeaderStyle-CssClass="gridViewHeader" BorderStyle="Solid" GridLines="Vertical"
                                    CssClass="Apariencia" Font-Bold="False">
                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                    <Columns>
                                        <asp:BoundField DataField="IdLineaNegocio" HeaderText="Codigo" InsertVisible="False"
                                            ReadOnly="True" SortExpression="IdLineaNegocio">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:RequiredFieldValidator ID="rfvNombre" runat="server" ControlToValidate="txtNombre"
                                    ...
                                    ValidationGroup="iNegocio" ForeColor="Red">*</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td align="left" bgcolor="#BBBBBB">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnImgInsertar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Visible="False" OnClick="btnImgInsertar_Click" ToolTip="Guardar" ValidationGroup="iNegocio"/>
                                        </td>
                                        <td>
                                            <asp:ImageButton ID="btnImgActualizar" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                Style="text-align: right" OnClick="btnImgActualizar_Click" ToolTip="Guardar" ValidationGroup="iNegocio"/>
                                        </td>
                                        <td>
