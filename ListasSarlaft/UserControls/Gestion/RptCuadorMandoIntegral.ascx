<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RptCuadorMandoIntegral.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Gestion.RptCuadorMandoIntegral" %>
    ...
    <ContentTemplate>
        <table align="center">
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label7" runat="server" ForeColor="White" Text="Reporte Indicadores"
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Ver" ToolTip="Ver Reporte" Width="112px" />
            ...
            <tr>
                <td>
                    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                        ...
                        <LocalReport ReportPath="Reportes\RptCuadorMandoIntegral.rdlc">
                            <DataSources>
                                <rsweb:ReportDataSource DataSourceId="SqlDataSourceCMI" Name="DataSetCuadroMandoIntegal" />
                            </DataSources>
                        </LocalReport>
                    </rsweb:ReportViewer>
                    <asp:SqlDataSource ID="SqlDataSourceCMI" runat="server" ConnectionString="<%$ ConnectionStrings:SarlaftConnectionString %>"
                        SelectCommand="SP_CuandroMandoIntegral" SelectCommandType="StoredProcedure">
                        <SelectParameters>
