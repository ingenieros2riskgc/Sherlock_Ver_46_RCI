<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParEveClaseEvento.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Riesgos.ParEveClaseEvento" %>
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Clase de evento"></asp:Label>
                </td>
            </tr>
            <tr align="center">
                <td>
                        ...
                        <tr align="center">
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="Clase de Evento" DataField="NombreClaseEvento" />
            ...
            <tr align="center" id="trCampos" runat="server" visible="false">
                <td>
                    <table>
                        <tr align="center">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Clase de evento" Font-Names="Calibri"
