<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParRieClasificacionGeneralRiesgo.ascx.cs" Inherits="ListasSarlaft.UserControls.Riesgos.ParRieClasificacionGeneralRiesgo" %>
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Clasificación general"></asp:Label>
                </td>
            </tr>
            <tr align="center">
                <td>
                            ...
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField HeaderText="Clasificación general" DataField="NombreClasificacionGeneralRiesgo" />
            ...
            <tr align="center" id="trCampos" runat="server" visible="false">
                <td>
                    <table>
                        <tr align="left">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label3" runat="server" Text="Clasificación global" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#EEEEEE">
                                <asp:DropDownList ID="DropDownList1" runat="server" Font-Names="Calibri" Font-Size="Small" Width="200px">
                        ...
                        <tr align="center">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Clasificación general" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                            </td>
                            <td bgcolor="#EEEEEE">
