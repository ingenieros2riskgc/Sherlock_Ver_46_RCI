<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ParPlaEvaTipoPrueba.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Riesgos.ParPlaEvaTipoPrueba" %>
            ...
            <tr align="center" bgcolor="#333399">
                <td>
                    <asp:Label ID="Label1" runat="server" Font-Bold="False" Font-Names="Calibri" Font-Size="Large"
                        ForeColor="White" Text="Tipo de prueba"></asp:Label>
                </td>
            </tr>
            <tr align="center">
                <td>
                        ...
                        <tr align="center">
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText="Tipo de prueba" DataField="NombreTipoPruebaPlanEvaluacion" />
            ...
            <tr align="center" id="trCampos" runat="server" visible="false">
                <td>
                    <table>
                        <tr align="center">
                            <td bgcolor="#BBBBBB">
                                <asp:Label ID="Label2" runat="server" Text="Tipo de prueba" Font-Names="Calibri"
