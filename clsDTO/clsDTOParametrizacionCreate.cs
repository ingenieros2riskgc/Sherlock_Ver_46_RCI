...
namespace clsDTO
{
    public class clsDTOParametrizacionCreate : clsDTOVariable
    {
        #region Properties
        ...
        public clsDTOParametrizacionCreate() { }

        public clsDTOParametrizacionCreate(string strIdUsuario, string strIdVariable, string strNombreParametro, 
